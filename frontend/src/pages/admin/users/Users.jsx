...
import { fetchUsers, updateUser, deleteUser } from "../../../api/user.api";
...
const Users = () => {
  ...
  const getUserTypeBadge = (type) => {
    const colors = {
      ...
      SELLER: "bg-green-900 text-green-300",
      LANDLORD: "bg-blue-900 text-blue-300",
      PG_OWNER: "bg-orange-900 text-orange-300",
      BUYER: "bg-cyan-900 text-cyan-300",
      TENANT: "bg-pink-900 text-pink-300",
      CO_LIVING: "bg-yellow-900 text-yellow-300",
      PG_SEEKER: "bg-indigo-900 text-indigo-300"
    };
